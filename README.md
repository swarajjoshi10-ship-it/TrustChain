# Trust Chain: AI-Verified Decentralized Escrow
Trust Chain is an event-driven, blockchain-based escrow system designed to ensure transparency in non-governmental organization (NGO) and public funding. It integrates decentralized storage and local, vision-based LLMs to automatically verify real-world proof of work before releasing funds to vendors.
## Problem Statement
...
Prerequisites
Node.js (v18+)
Ollama installed locally with the llava-phi3 model (ollama run llava-phi3)
